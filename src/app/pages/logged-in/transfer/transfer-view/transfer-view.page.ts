...
export class TransferViewPage implements OnInit {
  ...
  async loadData() {
    ...
    const query = 'expand=transferCandidates,transferCandidates.candidate,transferCandidates.contract,invoices,contract,contract.amount'
   ...
   */
  async transferCancel(transfer: Transfer) {
    // Load list of transfer
    const alert = await this.alertCtrl.create({
      header: 'Confirm cancelling the transfer?',
      message: 'You will no longer be able to edit the transfer once it\'s cancelled.',
      buttons: [
        {
          text: 'No',
          role: 'cancel'
        },
        {
          ...
          handler: async () => {
            ...
            loader.present();
            this.transferService.makeTransfertoCancel(transfer).subscribe(async response => {
